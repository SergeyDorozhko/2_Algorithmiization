...
public class Sort5 {
    /*
    Сортировка вставками. Дана последовательность чисел. Требуется пересавить числа в порядке возростания. Делается это следующим образом.
    Пусть а1, а2 , аN - упорядоченая последовательность, т.е a1 <= a2<= aN. берется следующее число aI+1 и вставяется в последовательность
    так, чтобы новая последователнось тоже возростающей. Процесс производится до тех пор пока все  элементы от aI+1 до N не дубут перебраны.
    */
